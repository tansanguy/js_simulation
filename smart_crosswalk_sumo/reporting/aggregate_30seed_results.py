    ...
    return "\n".join(
        [
            ...
            *root_lines,
            ...
            "      return 1",
            "    fi",
            f"    if ! {ctx['report_prefix']} --output_dir \"$out_dir\" --candidates \"$candidate_csv\" --nets_dir \"$NETS_DIR\" >>\"$log_file\" 2>&1; then",
            ...
            "    return 0",
            "  fi",
            f"  if ! {ctx['run_prefix']} >>\"$log_file\" 2>&1; then",
